        ...
        <div class="app-container">
            ...
            >
                ...
                <el-table :data="results">
                    ...
                    <el-table-column prop="time" label="发行日期" align="center" />
                </el-table>
            </el-card>
        </div>
    </div>
        ...
        getMobieList: function(movieInfo) {
            for (var key in movieInfo) {
                this.$data.results.push({
                    ...
                    score: movieInfo[key].score.score,
                    time: movieInfo[key].time == null ? "" : movieInfo[key].time.year + "-" + movieInfo[key].time.month + "-" + movieInfo[key].time.day
                })
            }
        },
        ngetMovieList: function(movieInfo) {
            for (var key in movieInfo) {
                this.$data.results.push({
                    id: movieInfo[key].productId,
                    title: movieInfo[key].title,
                    score: movieInfo[key].score,
                    time: movieInfo[key].time
                })
            }
        },
        clear: function() {
